...
if (MsgText[1] == "تاق للسرسريه" and is_JoinChannel(msg)) then 
if not msg.Admin then return "📛*│* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		ali = {'شهل صورة😍😌','لا قيمه للقمر امام وجهك🌚🥀','خليني احبك🙈❤️','ممكن خاص 🌚😹',' 🙈♥','منور اليوم 😻','فديت الحلو🌚😹','شهل عسل ،₍🍯😻⁾ ','الله عليك🙈❤️','يهلا بلعافيه😍','وعع😐','تحبني؟🙈',
		}
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@LeDew1"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : ديو](t.me/@LeDew1)',nil,inline,msg.id_)
return false
end
...
" شتبي","ها حبي 😍","ها عمري 🌹","مللتني",
"هااااا 🌚❤️","نعم حبي ","ماتسكت يامريض 😷؟",
" بسرعه شتبي 😤","ها ياقلبي ❤️","بغير اسمي بسببكم😡",
"لك فداك ["..Bot_Name.."] حبيبي انت اموووح 💋","قاعد اشرب جاي تعال غير جو معاي 😌","قول حبيبي أمرني 😍",
"خلصني وربي عذبت اهلي😒😏",
"اشغلتو اهل ["..Bot_Name.."] شتبي 😠","بووووووووو 👻 ها ها فزيت شفتك شفتك لا تحلف 😂",
"طالع  😒","هلا بالحلو  😍💕","قبل يومين غلطت علي انت صح😒؟؟ ",
"تعبت وانا افشلك ماتتوب؟😑😹","ياعيون ["..Bot_Name.."] أمرني 😍",
"انقلع","سويت مشاكل واجد في حياتي لاكن ماعمري قلت حق احد انجب😑",
"مشغول مع حبيتي  ☺️","مازا تريد مني 😌🍃"
}
local bs = {
"مابوس 🌚💔",
"آموووح❤️",
...
"تمام وانت يكيوت ؟ 💕",
"تمام وانت شلونك 😁❤️",
"ع حطت ايدك مافي تغيير شنسوي بالدنيا 🤷🏼‍♂️",
"لوني مثل لونك لاتسئل😒",
"زاقه معي",
}
local dr = {
"الله وياك والتوصيله على حساب المدير 😂😂 مالي دخل انا 🙈",
"هاك ريال اشتر فيها شوارما 🌝💋",
"بعدها وقت وين 🙄",
"من مزعلك 😥",
"وصل سلامي ",
"تعال وين رايح عندي شغله معاك 🐣",
"• وين رايح خلك  🙁💔",
"توناس 😔💔",
"وين خلينه مستانسين معاك 😂",
"تعال نطقطق عليك😋",
"انقلع",
"وين رايح للخاص ها 😉",
}
...
if msg.reply_id then
sendMsg(msg.chat_id_,msg.id_,'ابشر سيدي 🌝🍃')
...
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"عيب ابني/بنتي اتفل/ي اكبر منها شوية 😌😹")
elseif Text== "عبدالله" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/LeDew1")
elseif Text== "عبدالله البحريني " then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس ماكس 😍](t.me/LeDew-")
...
elseif Text== "وينك"  then return sendMsg(msg.chat_id_,msg.id_,"  متربع في قلبك 😍😍❤️")
...
elseif Text== "مح"  then return sendMsg(msg.chat_id_,msg.id_," يالهوووي🙈❤")
elseif Text== "شكرا" or Text== "ثكرا" then return  sendMsg(msg.chat_id_,msg.id_,"العفو"    )
...
elseif Text== "تتننحجة"  then return sendMsg(msg.chat_id_,msg.id_,"ديله شلون اطيق خلقتك اني😾🖖🏿🕷")
elseif Text== "اريد اكبل" then return sendMsg(msg.chat_id_,msg.id_,"خخ اني هم اريد اكبل قابل ربي وحد😹??️")
elseif Text== "ضوجهتتتعججك"  then return sendMsg(msg.chat_id_,msg.id_,"شي اكيد الكبل ماكو 😂 لو بعدك/ج مازاحف/ة 🙊😋")
elseif Text== "تنحجكتاغدكوصاك"  then return sendMsg(msg.chat_id_,msg.id_,"زاحفه 😂 منو هذا دزيلي صورهه")
elseif Text== "تتتنننناجيت" or Text=="اني تتنكةكنوواجيت" then return  sendMsg(msg.chat_id_,msg.id_,"كْـٌﮩٌﮧٌ﴿😍﴾ـﮩٌول الـ୭ـهـٌ୭ـْلا❤️")
elseif Text== "حفلش"  then return sendMsg(msg.chat_id_,msg.id_,"تعقب  🤓")
elseif Text== "نايمين" then return sendMsg(msg.chat_id_,msg.id_,"موجود😐
")
...
return sendMsg(msg.chat_id_,msg.id_,"حاضر     😇 ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"ع لى راسي  يا المنشئ تاج راسي 😌")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"لخاطرك راح اسكت لان مدير صدع راسي  😌")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"وانا رافعك  ادمن ؟؟ تقولي انجب 😏")
else 
return sendMsg(msg.chat_id_,msg.id_,"انجب انت  😏")
end 
end 
